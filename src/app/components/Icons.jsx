...
export const BgTemplates = ({ className, ...rest }) => (
  <svg viewBox="0 0 812 424" className="" xmlns="http://www.w3.org/2000/svg">
    <path
      opacity="0.3"
...
export const YoutubeImage = ({ className, ...rest }) => (
  <svg
    width="50px"
    height="50px"
    viewBox="0 -3 20 20"
...
export const YoutubeIcons = ({ className }) => {
  return (
    <svg
      height="32px"
      width="32px"
